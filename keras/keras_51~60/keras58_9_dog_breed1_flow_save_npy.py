...
#1 데이터
path = "d:/study_data/_data/dog's-Breed/dog_v1/"
...
xy_train = train_datagen.flow_from_directory(path, target_size = (100, 100), batch_size = 30, class_mode = 'categorical', color_mode = 'rgba', shuffle = False)
xy_test = train_datagen.flow_from_directory(path, target_size = (100, 100), batch_size = 30, class_mode = 'categorical', color_mode = 'rgba', shuffle = False)
...
np.save(save_path + "keras58_dog's-Breed_x_train.npy", arr = x_train)
np.save(save_path + "keras58_dog's-Breed_y_train.npy", arr = y_train)
np.save(save_path + "keras58_dog's-Breed_x_test.npy", arr = x_test)
np.save(save_path + "keras58_dog's-Breed_y_test.npy", arr = y_test)