...
xy_train = train_datagen.flow_from_directory(
    path, target_size = (100, 100), batch_size = 30, class_mode = 'binary', color_mode = 'rgb', shuffle = False)
...
np.save(save_path + "keras58_brain_x_train.npy", arr = x_train)
np.save(save_path + "keras58_brain_y_train.npy", arr = y_train)
np.save(save_path + "keras58_brain_x_test.npy", arr = x_test)
np.save(save_path + "keras58_brain_y_test.npy", arr = y_test)