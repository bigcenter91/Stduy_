...
np.save(save_path + "keras58_horse-or-human_x_train.npy", arr = x_train)
np.save(save_path + "keras58_horse-or-human_y_train.npy", arr = y_train)
np.save(save_path + "keras58_horse-or-human_x_test.npy", arr = x_test)
np.save(save_path + "keras58_horse-or-human_y_test.npy", arr = y_test)