...
cd_x_train = np.load(path + 'keras56_cat_dog_x_train.npy')
cd_x_test = np.load(path + 'keras56_cat_dog_x_test.npy')
cd_y_train = np.load(path + 'keras56_cat_dog_y_train.npy')
cd_y_test = np.load(path + 'keras56_cat_dog_y_test.npy')

print(cd_x_train.shape, cd_y_train.shape) # (24998, 100, 100, 3) (24998,)
