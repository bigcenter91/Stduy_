...
randindex = np.random.randint(50000, size = 10000)
...
np.save(save_path + "keras58_cifar100_x_train.npy", arr = x_train)
np.save(save_path + "keras58_cifar100_y_train.npy", arr = y_train)
np.save(save_path + "keras58_cifar100_x_test.npy", arr = x_test)
np.save(save_path + "keras58_cifar100_y_test.npy", arr = y_test)