...
#1 데이터
path = 'd:/study_data/_data/cat_dog/'
...
np.save(save_path + "keras58_cat_dog_x_train.npy", arr = x_train)
np.save(save_path + "keras58_cat_dog_y_train.npy", arr = y_train)
np.save(save_path + "keras58_cat_dog_x_test.npy", arr = x_test)
np.save(save_path + "keras58_cat_dog_y_test.npy", arr = y_test)