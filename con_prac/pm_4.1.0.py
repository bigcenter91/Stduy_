...
for i in range(72):
    ...
    globals()['model{}'.format(i+1)].add(LSTM(512, input_shape=(timesteps, x1_train.shape[2])))
    ...
    globals()['model{}'.format(i+1)].add(Dense(16, activation='relu'))
    globals()['model{}'.format(i+1)].add(Dense(32, activation='relu'))
...
submission['PM2.5']=l
submission.to_csv('c:/study_data/_data/pm2.5/_Submit_time0508.csv')
