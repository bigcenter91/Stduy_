...
stt = time.time()
model1.fit(x_train, y_train, batch_size=4000, epochs=1,
          callbacks=[es,rl],
          validation_split=0.2)

model2.fit(x_rev_train, y_rev_train, batch_size=4000, epochs=1,
          callbacks=[es,rl],
          validation_split=0.2)
...
submission.to_csv('c:/study_data/_save/Aiur_submission_0503.csv')
...
# 5.3 Save Weight
model1.save("./_save/Aiur_Submit1_0503.h5")
model2.save("./_save/Aiur_Submit2_0503.h5")
