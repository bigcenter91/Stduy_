...
train_x, val_x, train_y, val_y = train_test_split(train_x, train_y, test_size=0.2, random_state=333)
...
# n_estimators' : [500],'learning_rate' : [ 0.001],'max_depth': [7, 8], 'subsample' : [1],
# Accuracy_score: 0.8226505362639949
# F1 Score:f1 0.7432409425533927 // 0.79



# 'n_estimators' : [600], 'learning_rate' : [ 0.001],  'max_depth': [6 ,7, 8], 'subsample' : [1],
# Accuracy_score: 0.8226113213466403
# F1 Score:f1 0.7429233606230548