    ...
    for k in range(64):
        for i in range(72):
            test_pm[j, 120*k+i+48, pm_col_num] = globals()['model{}'.format(i+1)].predict\
                (np.concatenate([test_pm_onehot[j, 120*k+48-timesteps:120*k+48, :], test_pm_aws[j, 120*k+48-timesteps:120*k+48, :]], axis=2)\
...
submission['PM2.5']=l
submission.to_csv('c:/study_data/_save/dust/_Submit_time1423.csv')
