...
model2.fit(x_rev_train, y_rev_train, batch_size=128, epochs=50,
          callbacks=[es,rl],
          validation_split=0.2)
...
# 5.2 Save Submit
submission['PM2.5']=l
submission.to_csv('c:/study_data/_save/Aiur_Submit_time0503.csv')
...
model1.save("c:/study_data/_save/Aiur_Submit5.h5")
model2.save("c:/study_data/_save/Aiur_Submit6.h5")
