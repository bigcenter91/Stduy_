...
hidden_layer_size = [16, 32, 24, 56, 33]
...
def autoencoder(hidden_layer_size):
    ...
    model.add(Dense(units=hidden_layer_size[1], input_shape=(784,)))
    model.add(Dense(units=hidden_layer_size[2], input_shape=(784,)))
    model.add(Dense(units=hidden_layer_size[3], input_shape=(784,)))
    model.add(Dense(units=hidden_layer_size[4], input_shape=(784,)))
...
model = autoencoder(hidden_layer_size=hidden_layer_size)  #PCA 100프로 성능
