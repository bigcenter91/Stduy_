...
answer_sample=pd.read_csv('c:/study_data/_data/dust/answer_sample.csv') # C:\study_data\_data\dust
print(answer_sample)
...
answer_sample.to_csv('c:/_data/_data/dust/sample_sub.csv',index=False)